<!--Code was edited from here: https://github.com/CaptainCodeman/sveltekit-dark-mode-->
...
<button
	class="rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2"
	class:hidden
	on:click={toggle}
>
	<!-- moon icon -->
	<svg class="h-5 w-5 text-accent-dark mt-1" class:hidden={!dark} viewBox="0 0 20 20" fill="currentColor">
		<path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
	</svg>
	<!-- sun icon -->
	<svg class="h-5 w-5 text-accent mt-1" class:hidden={dark} viewBox="0 0 20 20" fill="currentColor">
		<path
			fill-rule="evenodd"
